...
export default function ChatbotBookingDrawer({ isOpen, onClose, doctor }: ChatbotBookingDrawerProps) {
  ...
  return (
    <>
      <div onClick={handleClose} className="fixed inset-0 bg-slate-950/40 backdrop-blur-sm z-50 transition-opacity" />
      ...
      <aside className={`fixed right-0 top-0 h-full w-full max-w-[480px] bg-white shadow-2xl z-50 flex flex-col transform transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
        ...
        {step === 'success' && (
          <div className="flex-1 flex flex-col items-center justify-center px-8 text-center bg-white">
            <div className="w-24 h-24 rounded-full bg-teal-50 flex items-center justify-center mb-6 ring-8 ring-teal-50/50">
            ...
            <div className="w-full bg-gradient-to-br from-teal-50/50 to-slate-50 border border-teal-100/75 rounded-2xl p-5 text-left mb-8 space-y-3">
              <div className="flex items-center gap-3 pb-3 border-b border-teal-100/50">
              ...
              <div className="flex justify-between items-center pt-3 border-t border-teal-100/50">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <input type="text" placeholder="Full Name" value={fullName} onChange={(e) => setFullName(e.target.value)}
                    className="w-full px-4 py-2.5 rounded-xl border border-slate-200 bg-slate-50 text-sm focus:border-teal-400 transition-all outline-none" />
