...
import { DoctorAppointment, AppointmentStatus } from '@/services/doctor.service';
...
const STATUS_CONFIG: Record<AppointmentStatus, { dot: string; badge: string; label: string }> = {
  Confirmed: {
    dot: 'bg-teal-500',
 ...
 */
export default function DoctorScheduleTimeline({ appointments }: Props) {
