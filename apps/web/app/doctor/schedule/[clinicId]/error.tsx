...
export default function ClinicScheduleError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("Clinic Schedule Manager error:", error);
  }, [error]);
      ...
      <div className="flex flex-col items-center gap-6 p-10 max-w-lg text-center">
        ...
        <div className="space-y-2">
          <h1 className="text-2xl font-black text-gray-900 tracking-tight">
            Clinic Manager Error
          </h1>
          <p className="text-gray-500 text-sm leading-relaxed max-w-sm">
            Unable to load the clinic schedule manager. The clinic may not exist
            or there was a database error. Please go back and try a different
            clinic.
          </p>
          {error?.message && (
