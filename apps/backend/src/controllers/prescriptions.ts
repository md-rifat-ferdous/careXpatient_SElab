...
import * as prescriptionService from '../services/prescriptions';
...
export const downloadPrescriptionPDF = async (req: Request, res: Response) => {
  try {
    ...
    // We will create a dedicated print route on the frontend
    await page.goto(`http://localhost:3000/prescriptions/${id}/print`, {
