...
import FilterDrawer, { defaultFilters } from '../../../../components/appointments/FilterDrawer';
...
const SORT_OPTIONS = ['Recommended', 'Rating', 'Fee (Low to High)', 'Experience'];
  ...
  useEffect(() => {
    const init = async () => {
      ...
      try {
        ...
        setSpecialties(specsData.map((s) => s.name));
      } catch (err) {
