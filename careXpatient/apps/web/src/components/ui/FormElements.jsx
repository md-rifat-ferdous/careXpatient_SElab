...
export function Input({ error, leftIcon, rightElement, className, ...props }) {
  return (
...
export function Select({ error, placeholder, children, className, ...props }) {
  return (
    <select
...
export function FileUpload({ label, accept = 'image/*,.pdf', onChange, preview, hint }) {
...
export function NavButtons({ onBack, onNext, nextLabel, isLoading, isLastStep, backLabel = 'Back' }) {
  return (
