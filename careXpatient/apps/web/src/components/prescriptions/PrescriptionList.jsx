...
const PrescriptionList = ({ prescriptions, loading, selectedId, onSelect }) => {
  if (loading) {
    return (
                ...
                <tr
                  ...
                  <td className="px-6 py-3.5 align-middle">
                    <div className="flex items-center gap-2.5">
                      ...
                      <img
                        src={p.doctorPhoto || `https://ui-avatars.com/api/?name=${encodeURIComponent(p.doctorName)}&background=0D9488&color=fff`}
                        alt={p.doctorName}
                  ...
                  <td className="px-6 py-3.5 align-middle text-right">
                    <div className="flex items-center justify-end gap-1" onClick={(e) => e.stopPropagation()}>
                      ...
                      <a
                        href={`${API_BASE}/prescriptions/${p.id}/pdf`}
