      ...
      <nav className="fixed top-0 left-0 right-0 z-50 glass h-20 flex items-center">
        <div className="container mx-auto px-6 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/auth" className="hidden sm:block font-semibold hover:text-primary transition-colors px-4 py-2">Login</Link>
            <Link href="/auth" className="bg-primary text-white px-6 py-2.5 rounded-full font-semibold shadow-lg shadow-primary/20 hover:scale-105 active:scale-95 transition-all">
              Get Started
            </Link>
        ...
        <div className={`fixed inset-0 bg-background/95 backdrop-blur-xl z-40 lg:hidden transition-all duration-300 ${isMenuOpen ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-full pointer-events-none'}`}>
          <div className="flex flex-col items-center justify-center h-full gap-8 text-2xl font-bold">
            ...
            <div className="flex gap-4 mt-8">
              <Link href="/auth" className="px-8 py-3 border rounded-full text-lg">Login</Link>
              <Link href="/auth" className="px-8 py-3 bg-primary text-white rounded-full text-lg">Get Started</Link>
            </div>
          </div>
        </div>
      </nav>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2">
              ...
              <div className="flex flex-wrap gap-4 animate-in fade-in slide-in-from-bottom-16 duration-700 delay-200">
                ...
                <Link href="/dashboard/lab-tests" className="bg-white text-primary border-2 border-primary/10 px-8 py-4 rounded-2xl font-bold text-lg hover:bg-primary/5 transition-all flex items-center justify-center">
                  Book a Lab Test
                </Link>
              </div>
          ...
          <div className="max-w-5xl mx-auto bg-white rounded-[2rem] shadow-2xl shadow-primary/10 border border-primary/5 p-8 lg:p-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
              ...
              <div className="flex items-end">
                <Link href="/dashboard/lab-tests" className="w-full bg-primary text-white py-4 rounded-2xl font-bold text-lg hover:bg-primary/90 transition-all flex items-center justify-center gap-2 shadow-lg shadow-primary/20">
